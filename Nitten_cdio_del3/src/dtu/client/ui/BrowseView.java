...
public class BrowseView extends Composite {
	...
	public BrowseView(final KartotekServiceClientImpl clientImpl) {
	 ...
	 // Add a normal ToggleButton
	    final ToggleButton toggleButton = new ToggleButton("Vis roller");
		toggleButton.setPixelSize(80, 20);
		toggleButton.getUpFace().setText("Vis roller");
		toggleButton.getDownFace().setText("Skjul roller");
...
//					toggleButton.setPixelSize(60, 20);
				} else {
